...
namespace PDS.WITSMLstudio.Desktop.Plugins.EtpBrowser.ViewModels
{
    ...
    public sealed class Hierarchy12ViewModel : HierarchyViewModelBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Hierarchy12ViewModel"/> class.
        /// </summary>
        public Hierarchy12ViewModel(IRuntimeService runtime) : base(runtime)
        {
        ...
        {
            CopyUriToStreaming<Streaming12ViewModel>(x => x.AddUri());
        }
