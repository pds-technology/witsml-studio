...
{
    public class Etp11ChannelStreamingProxy : EtpProxyViewModel
    {
        private static readonly log4net.ILog _log = log4net.LogManager.GetLogger(typeof(Etp11ChannelStreamingProxy));
        private readonly Random _random;

        public Etp11ChannelStreamingProxy(IRuntimeService runtime, string dataSchemaVersion, Action<string> log) : base(runtime, dataSchemaVersion, log)
        {
        ...
        {
            Model = model;
            Simulator = new Etp11Simulator(model);
